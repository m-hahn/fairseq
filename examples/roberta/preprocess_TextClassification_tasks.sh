...
if [[ $# -ne 2 ]]; then
  ...
  echo "./examples/roberta/preprocess_TextClassification_tasks.sh <glud_data_folder> <task_name>"
  exit 1
fi

TextClassification_DATA_FOLDER=$1
...
do
  ...
  TASK_DATA_FOLDER="$TextClassification_DATA_FOLDER/$TASK"
  ...
  do
    ...
    do
      ...
      ~/python-py37-mhahn -m examples.roberta.multiprocessing_bpe_encoder \
