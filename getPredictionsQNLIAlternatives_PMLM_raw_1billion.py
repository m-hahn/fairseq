...
evaluatedSoFar = set()
lineNumbers = 0
with open('/u/scr/mhahn/PRETRAINED/GLUE/glue_data/QNLI/dev_alternatives_predictions_PMLM_1billion_raw.tsv', "w") as outFile:
 with open(f'/u/scr/mhahn/PRETRAINED/GLUE/glue_data/QNLI/dev_alternatives_PMLM_1billion_raw.tsv', 'r') as fin:
    while True:
        lineNumbers += 1
        line = next(fin).strip()
        try:
