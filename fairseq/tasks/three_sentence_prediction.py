...
@register_task('three_sentence_prediction')
class ThreeSentencePredictionTask(FairseqTask):
    """
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return ThreeSentencePredictionTask(args, data_dict, label_dict)
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        if input1 is None:
            ...
            src_tokens = ConcatSentencesDataset(input0, input1, input2)
