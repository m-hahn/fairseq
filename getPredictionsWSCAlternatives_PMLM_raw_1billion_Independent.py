...
fromOriginal = {}
with open("/u/scr/mhahn/PRETRAINED/WSC/val_alternatives_c_OnlySubsetsNoAlternatives.txt", "r") as inFile: # _SECOND_VERSION_BACKUP
...
with open(f"/u/scr/mhahn/PRETRAINED/WSC/val_alternatives_predictions_PMLM_1billion_raw_Independent.txt", "w") as outFile:
 with open("/u/scr/mhahn/PRETRAINED/WSC/val_alternatives_PMLM_1billion_raw_Independent.tsv", "r") as inFile: # _SECOND_VERSION_BACKUP
  while True:
   try:
