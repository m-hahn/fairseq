...
roberta.eval()
evaluatedSoFar = set()
with open('/u/scr/mhahn/PRETRAINED/GLUE/glue_data/RTE/dev_alternatives_predictions_PMLM_1billion_raw_OnlySEP.tsv', "w") as outFile:
 with open(f'/u/scr/mhahn/PRETRAINED/GLUE/glue_data/RTE/dev_alternatives_PMLM_1billion_raw_OnlySEP.tsv', 'r') as fin:
    while True:
        line = next(fin).strip()
        try:
